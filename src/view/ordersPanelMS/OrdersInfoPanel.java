...
public class OrdersInfoPanel extends JPanel {
	...
	private void GridBagLayout() {   
        ...
        Border innerBorderOrderTable = BorderFactory.createLineBorder(Color.GRAY);
        Border outerBorderOrderTable = BorderFactory.createEmptyBorder(5, 5, 5, 5);
        orderTablePanel.setBorder(BorderFactory.createCompoundBorder(outerBorderOrderTable, innerBorderOrderTable));
